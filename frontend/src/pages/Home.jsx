      ...
      <section className="relative pt-12 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6">
          <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-slate-800/80 border border-slate-700/80 text-xs font-mono text-cyan-400">
            ...
            <span>National Cyber Threat Intelligence Platform • Government of India Telemetry</span>
          </div>
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            A national cyber defense and threat intelligence platform analyzing real-world cyber incidents from the 
          ...
          <div className="flex items-center justify-center space-x-2 text-xs text-slate-400">
            <span>Engineered by <strong className="text-cyan-400">Sujal Shrivastav</strong> • Security Researcher & Developer</span>
            <span>•</span>
            <a 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div className="cyber-card rounded-2xl p-5 border border-slate-800/80">
            ...
            <div className="text-2xl sm:text-3xl font-extrabold text-white mt-2">{I4C_CASES.length}+ Cases</div>
            <p className="text-xs text-slate-400 mt-1">Verified Real-World Threat Incidents</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10 space-y-2">
          ...
          <p className="text-slate-400 text-sm">
            Analysis of verified cyber incidents reveals a repeatable 5-stage attack chain combining social engineering, technical exploitation, and regulatory bypass.
          </p>
        </div>
